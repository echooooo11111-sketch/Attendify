...
import { Shield, Database, Lock, Share2, CheckCircle, Bell, Mail } from 'lucide-react';
  ...
  const sections = [
    {
      ...
      subsections: [
        ...
        {
          title: 'Location Data',
          description: 'For geofencing functionality, we collect GPS coordinates and location information. This data is used solely to determine attendance status within school boundaries. You can disable location tracking in your device settings at any time.',
        },
        {
          title: 'Camera Access',
          description: 'To use QR code scanning features, we request camera access. The camera is used only for scanning attendance QR codes and is not stored or accessed without your explicit permission.',
        },
        {
          title: 'Attendance Records',
          description: 'We collect and maintain records including timestamps, location data at time of check-in, and attendance status. This information is essential for the core functionality of the Attendify system.',
        },
        {
          title: 'Device Information',
          description: 'We automatically collect device identifiers, device type, operating system version, mobile network information, and app crash logs to improve service quality and functionality.',
        },
      ],
    },
    {
    ...
    },
    {
      icon: Lock,
      title: 'Data Security',
      description: 'The security of your data is important to us but remember that no method of transmission over the Internet or method of electronic storage is 100% secure. We implement the following security measures:',
      items: [
    ...
    },
    {
      ...
      description: 'We do not share your personal information with third parties except:',
      items: [
        {
    ...
    },
    {
      ...
      description: 'We may update our Privacy Policy from time to time. We will notify you of any changes by posting the new Privacy Policy on this page and updating the "Last updated" date at the top. You are advised to review this Privacy Policy periodically for any changes.',
    },
    {
      icon: Mail,
      title: 'Contact Us',
    ...
    >
      <div className="max-w-4xl space-y-8">
        ...
        <Card className="border-border p-6">
          <h2 className="mb-4 font-semibold text-foreground">Quick Navigation</h2>
          ...
          return (
            <section key={idx} id={`section-${idx}`} className="scroll-mt-20">
              <div className="mb-4 flex items-center gap-3">
                ...
                <h2 className="text-2xl font-bold text-foreground">{idx + 1}. {section.title}</h2>
              </div>

              {section.description && (
                <p className="mb-6 text-muted-foreground leading-relaxed">{section.description}</p>
              )}
              ...
              {section.subsections && (
                <div className="space-y-4">
                  {section.subsections.map((subsection, subIdx) => (
                    <Card key={subIdx} className="border-border p-5 transition-shadow hover:shadow-sm">
                      <h3 className="mb-3 font-semibold text-foreground">{subsection.title}</h3>
