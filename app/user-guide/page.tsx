...
import { Download, MapPin, QrCode, Users, BarChart3, Settings } from 'lucide-react';

export const metadata = {
  title: 'User Guide - Attendify',
  description: 'Learn how to use Attendify for efficient attendance management.',
};
  ...
  const guides = [
    {
      ...
      content: [
        ...
        'Create an account with your school credentials',
    ...
    },
    {
      ...
      content: [
        'Teachers generate unique QR codes from the dashboard',
        'Students open the app and tap "Scan QR Code"',
    ...
    >
      ...
      <div className="grid gap-8 md:grid-cols-2">
        {guides.map((guide, index) => {
          ...
          return (
            <Card key={index} id={sectionIds[index]} className="overflow-hidden">
      ...
      <div className="mt-12 rounded-2xl border border-border bg-gradient-to-br from-primary/5 to-primary/10 p-8">
        ...
        <p className="mb-6 text-muted-foreground">
          If you have additional questions or encounter issues, please don&apos;t
