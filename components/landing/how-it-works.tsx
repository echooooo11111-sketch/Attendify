import { Download, UserPlus, MapPin, CheckCircle, ArrowRight } from "lucide-react";
...
const steps = [
  ...
  },
  {
    ...
    description:
      "Register as a Teacher, Student, or Secretary. Your school admin will verify your account quickly.",
...
export function HowItWorks() {
  return (
    <section id="how-it-works" className="relative overflow-hidden bg-muted/30 py-20 md:py-28">
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mb-16 text-center">
          ...
          <p className="mx-auto max-w-2xl text-pretty text-lg text-muted-foreground">
            Setting up Attendify is quick and easy. Follow these simple steps 
            to start tracking attendance automatically.
          </p>
        </div>
            ...
            {steps.map((step, index) => (
              <div key={index} className="relative">
                ...
                <div className="text-center">
                  {/* Step number circle */}
                  <div className={`relative z-10 mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-br ${step.color} text-2xl font-bold text-white shadow-xl`}>
                    {step.step}
                    {/* Ring effect */}
                    <div className={`absolute inset-0 rounded-full bg-gradient-to-br ${step.color} opacity-30 blur-md`} />
                  </div>

                  {/* Card */}
                  <div className="rounded-3xl border border-border bg-card p-6 shadow-sm transition-all hover:shadow-lg">
                    {/* Icon */}
                    <div className={`mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br ${step.color} text-white shadow-lg`}>
        ...
        <div className="mt-16 text-center">
          <Button size="lg" className="h-14 gap-3 px-10 text-base shadow-lg shadow-primary/25">
