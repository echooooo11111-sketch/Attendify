...
import { Download, MapPin, QrCode, Shield, Smartphone, Star, Users, Zap } from "lucide-react";
  ...
  return (
    <section className="relative overflow-hidden py-16 md:py-24 lg:py-32">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute bottom-20 right-1/4 h-96 w-96 animate-pulse rounded-full bg-accent/15 blur-3xl" style={{ animationDelay: "1s" }} />
        {/* Grid pattern */}
        ...
        <div className="flex flex-col items-center gap-12 lg:flex-row lg:gap-20">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-primary/20 bg-primary/5 px-4 py-1.5">
              ...
              <span className="text-sm font-medium text-primary">Smart Attendance Solution</span>
            </div>
            ...
            <div className="mb-6 flex items-center justify-center gap-3 lg:justify-start">
              ...
              <span className="text-3xl font-bold tracking-tight">Attendify</span>
            </div>
            ...
            <p className="mx-auto mb-8 max-w-xl text-pretty text-lg leading-relaxed text-muted-foreground lg:mx-0 lg:text-xl">
              Automate student attendance tracking with GPS geofencing and QR codes. 
              Save time, reduce errors, and gain real-time insights for your school.
            </p>

            {/* CTA Buttons */}
            <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center lg:justify-start">
              <Button size="lg" className="h-14 gap-3 px-8 text-base shadow-lg shadow-primary/25 transition-all hover:shadow-xl hover:shadow-primary/30">
          ...
          <div className="relative flex-1">
            <div className="relative mx-auto w-[300px] md:w-[340px]">
              ...
              <div className="relative rounded-[3rem] border-[14px] border-foreground/90 bg-foreground/90 p-1 shadow-2xl">
                ...
                <div className="relative overflow-hidden rounded-[2.3rem] bg-background">
                  ...
                  <div className="p-5">
                    ...
                    <div className="mb-5 overflow-hidden rounded-2xl border border-green-200 bg-gradient-to-br from-green-50 to-green-100/50">
                      <div className="flex items-center justify-between p-4">
                        <div>
                          ...
                          <p className="text-2xl font-bold text-green-800">7:45 AM</p>
                          <p className="text-xs text-green-600">Mathematics - Room 101</p>
                        </div>
                    ...
                    {/* Schedule */}
                    <div>
                      <p className="mb-3 text-sm font-semibold">{"Today's Schedule"}</p>
                      <div className="space-y-2">
                        <div className="flex items-center justify-between rounded-xl bg-primary/5 p-3">
                          ...
                          <span className="text-xs text-muted-foreground">8:00 - 9:00</span>
                        </div>
                        <div className="flex items-center justify-between rounded-xl bg-muted/50 p-3">
                          ...
                          <span className="text-xs text-muted-foreground">9:00 - 10:00</span>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              {/* Floating badges */}
              <div className="absolute -left-8 top-1/4 animate-bounce rounded-2xl border border-border bg-card p-4 shadow-xl" style={{ animationDuration: "3s" }}>
                <div className="flex items-center gap-3">
              ...
              <div className="absolute -right-8 bottom-1/3 animate-bounce rounded-2xl border border-border bg-card p-4 shadow-xl" style={{ animationDuration: "3.5s", animationDelay: "0.5s" }}>
                <div className="flex items-center gap-3">
