...
import { Download, Mail, MapPin, Phone, Github, ExternalLink } from "lucide-react";
        ...
        <div className="relative overflow-hidden rounded-[2.5rem] bg-gradient-to-br from-primary via-primary to-primary/90 p-8 text-center text-primary-foreground md:p-16">
          ...
          <div className="relative z-10">
            ...
            <p className="mx-auto mb-8 max-w-2xl text-pretty text-lg opacity-90">
              Join schools that have simplified their attendance tracking with Attendify.
              Download now and experience the future of attendance management.
            </p>
        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="mb-6 max-w-sm text-pretty leading-relaxed text-muted-foreground">
              ...
              for schools and educational institutions. Built with modern technology
              for reliable, automated tracking.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <a href="#features" className="flex items-center gap-2 text-muted-foreground transition-colors hover:text-primary">
                  Features
                </a>
              </li>
              <li>
                <a href="#how-it-works" className="flex items-center gap-2 text-muted-foreground transition-colors hover:text-primary">
                  How It Works
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <a href="mailto:support@attendify.app" className="flex items-center gap-3 text-muted-foreground transition-colors hover:text-primary">
              ...
              <li>
                <a href="tel:+639123456789" className="flex items-center gap-3 text-muted-foreground transition-colors hover:text-primary">
                  <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-primary/10">
