import { MapPin, QrCode, WifiOff, Users, Shield, BarChart3, Bell, Smartphone } from "lucide-react";
...
const features = [
  ...
  },
  {
    ...
    description:
      "Works seamlessly without internet. Data syncs automatically when connection is restored.",
    highlight: false,
  },
  {
    icon: Users,
  ...
  },
  {
    ...
    description:
      "Built with Kotlin for optimal performance. Smooth experience on all Android devices.",
    highlight: false,
  },
];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mb-16 text-center">
          ...
          <p className="mx-auto max-w-2xl text-pretty text-lg text-muted-foreground">
            Attendify combines cutting-edge technology with simplicity to revolutionize 
            how schools track student attendance.
          </p>
        </div>
