...
const roles = [
  {
    icon: GraduationCap,
    title: "Teachers",
    description: "Manage classes and track student attendance with powerful tools.",
    features: [
  ...
  },
  {
    icon: Users,
    title: "Students",
    description: "Easy attendance tracking with automatic check-in capabilities.",
    features: [
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid gap-8 lg:grid-cols-3">
          {roles.map((role, index) => (
            ...
            >
              {/* Icon */}
              <div className={`mb-6 flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br ${role.color} text-white shadow-lg`}>
              ...
              <ul className="space-y-3">
                {role.features.map((feature, featureIndex) => (
                  <li key={featureIndex} className="flex items-start gap-3">
                    <div className={`mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full ${role.textColor} bg-current/10`}>
